...
// hs002 new for event bus implementation - put here to code to receive a post event from event bus at /events
// print a message on the console of the event data reeceived
app.post('....', (req, res) => {
    console.log(".....", ....);
    res.send({});
});
